...
public partial class PlaceOrder : System.Web.UI.Page
{
    ...
    {
        String updatepass = "insert into orderaddress(orderid,address,mobilenumber,firstname,lastname,pincod) values('" + Label3.Text + "','" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "')";
        String mycon1 = "Data Source=mypc-PC;Initial Catalog=ShoppingData;Integrated Security=True";
