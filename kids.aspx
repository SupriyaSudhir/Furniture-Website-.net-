...
<table>
    ...
    <div style="height: 666px; width: 1354px;">
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:kidConnectionString %>" SelectCommand="SELECT * FROM [ProductDetail]" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
