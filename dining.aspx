...
<table>
    ...
    <div style="height: 666px; width: 1354px;">
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:diningConnectionString3 %>" SelectCommand="SELECT * FROM [ProductTable]"></asp:SqlDataSource>
