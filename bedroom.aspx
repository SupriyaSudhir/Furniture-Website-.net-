<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bedroom.aspx.cs" Inherits="bedroom" %>
...
<table>
    ...
    <div style="height: 666px; width: 1354px;">
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bedroomConnectionString %>" SelectCommand="SELECT * FROM [ProductDetail]"></asp:SqlDataSource>
